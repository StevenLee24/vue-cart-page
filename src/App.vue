...
import Hproduct from "@/components/homeproduct.vue";
...
<template>
  ...
  <div id="cart-sidebar" class="cart-sidebar" :class="{ show: isCartOpen }">
    ...
    <div class="cart-products">
      <Product v-for="product in products" :key="product.id" :product="product" @remove-item="removeItem"
        @decrement-quantity="decrementQuantity" @increment-quantity="incrementQuantity" />
    </div>
    <!-- footer -->
  ...
  <!-- <Hproduct v-for="product in products" :key="product.id" :product="product" @add-product="addproduct" /> -->
  <Hproduct v-for="product in addproducts" :key="product.id" :product="product" @add-product="addproduct" />
</template>
